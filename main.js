...
async function GetWeather(){
    document.getElementById('loader').innerHTML="<img src='Loading Icon.gif'>";
    document.getElementById('loader2').innerHTML="<img src='Loading Icon.gif'>";
...
async function searchWeather(){
    ...
    document.getElementById("loader3").innerHTML="<img src='Loading Icon.gif'>";
